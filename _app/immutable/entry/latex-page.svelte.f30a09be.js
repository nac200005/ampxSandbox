...
\r
    ...
    :root::-webkit-scrollbar-thumb:hover {\r
      background: #fbbf24;\r
    }`),d.forEach(f),P.forEach(f),a=A(n),s=v(n,"DIV",{class:!0});var y=w(s);c=v(y,"H2",{class:!0});var O=w(c);r=T(O,"Simpson Research"),O.forEach(f),l=A(y),e=v(y,"H2",{class:!0});var M=w(e);i=T(M,"All the PDFs were made with "),t=v(M,"A",{href:!0,rel:!0,target:!0,class:!0});var $=w(t);D=T($,"LaTeX"),$.forEach(f),M.forEach(f),F=A(y),x=v(y,"H2",{class:!0});var q=w(x);_=T(q,"Check out "),m=v(q,"A",{rel:!0,target:!0,href:!0,style:!0,class:!0});var U=w(m);S=T(U,"RaTeX"),U.forEach(f),L=T(q," to build PDF's like this in Python!"),q.forEach(f),V=A(y);for(let N=0;N<k.length;N+=1)k[N].l(y);y.forEach(f),I=A(n),X=v(n,"DIV",{class:!0}),w(X).forEach(f),this.h()},h(){h(c,"class","text-black text-6xl mt-10 font-black"),h(t,"href","https://www.latex-project.org/"),h(t,"rel","noopener noreferrer"),h(t,"target","_blank"),h(t,"class","hover:underline text-amber-500 font-black tracking-wider"),h(e,"class","text-black text-lg mt-6"),h(m,"rel","noopener noreferrer"),h(m,"target","_blank"),h(m,"href","https://github.com/realTristan/ratex"),re(m,"background","none"),h(m,"class","text-amber-500 font-black hover:underline tracking-wider"),h(x,"class","text-black text-lg mt-2"),h(s,"class","flex flex-col items-center justify-center my-10 mx-10"),h(X,"class","my-12 w-10 h-1")},m(n,P){u(document.head,o),u(o,b),C(n,a,P),C(n,s,P),u(s,c),u(c,r),u(s,l),u(s,e),u(e,i),u(e,t),u(t,D),u(s,F),u(s,x),u(x,_),u(x,m),u(m,S),u(x,L),u(s,V);for(let d=0;d<k.length;d+=1)k[d]&&k[d].m(s,null);C(n,I,P),C(n,X,P)},p(n,[P]){if(P&1){H=Object.keys(n[0]);let d;for(d=0;d<H.length;d+=1){const y=B(n,H,d);k[d]?k[d].p(y,P):(k[d]=K(y),k[d].c(),k[d].m(s,null))}for(;d<k.length;d+=1)k[d].d(1);k.length=H.length}},i:Y,o:Y,d(n){f(o),n&&f(a),n&&f(s),Q(k,n),n&&f(I),n&&f(X)}}}function oe(p,o,b){let a={};const s=r=>(r=r.replace("api.github.com/repos/Simpson-Computer-Technologies-Research/LaTeX/contents/","raw.githubusercontent.com/Simpson-Computer-Technologies-Research/LaTeX/main/"),r.split("?ref")[0]+"/build/main.pdf"),c=async(r,l)=>{await fetch(l).then(e=>e.json()).then(e=>{for(var i=0;i<e.length;i++)b(0,a[r].docs=[...a[r].docs,{name:e[i].name,pdf_url:s(e[i].url),src_url:e[i].html_url}],a)})};return le(async()=>{await fetch("https://api.github.com/repos/Simpson-Computer-Technologies-Research/LaTeX/contents/").then(r=>r.json()).then(async r=>{for(let l=0;l<r.length;l++)["LICENSE",".vscode","README.md","Hidden",".gitignore"].includes(r[l].name)||(b(0,a[r[l].sha]={name:r[l].name,docs:[]},a),await c(r[l].sha,r[l].url))})}),[a]}class ne extends Z{constructor(o){super(),j(this,o,oe,ae,ee,{})}}export{ne as default};
